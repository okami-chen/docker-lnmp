...
RUN tar zxf lnmp1.7.tar.gz && cd lnmp1.7 \
    ...
    && wget https://github.91chifun.workers.dev/https://github.com/swoole/swoole-src/archive/master.tar.gz \
    ...
    && cd /tmp && wget https://github.91chifun.workers.dev/https://github.com/phpredis/phpredis/archive/refs/tags/5.3.4.zip \
