...
Openssl_New_Ver='openssl-1.1.1k'
...
if [ "${DBSelect}" = "1" ]; then
    ...
    Mysql_Ver='mysql-8.0.25'
elif [ "${DBSelect}" = "6" ]; then
    Mariadb_Ver='mariadb-5.5.68'
elif [ "${DBSelect}" = "7" ]; then
    Mariadb_Ver='mariadb-10.1.48'
elif [ "${DBSelect}" = "8" ]; then
    Mariadb_Ver='mariadb-10.2.38'
elif [ "${DBSelect}" = "9" ]; then
    Mariadb_Ver='mariadb-10.3.29'
elif [ "${DBSelect}" = "10" ]; then
    Mariadb_Ver='mariadb-10.4.19'
fi
if [ "${PHPSelect}" = "1" ]; then
    Php_Ver='php-5.2.17'
...
PHP8Memcache_Ver='memcache-8.0'
PHPOldApcu_Ver='apcu-4.0.11'
PHPNewApcu_Ver='apcu-5.1.20'
